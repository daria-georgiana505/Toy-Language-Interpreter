...
public class ArithExp implements Exp{
        ...
        if(v1.getType().equals(new IntType()))
        {
            ...
            if(v2.getType().equals(new IntType()))
            {
                ...
                switch(op) {
                    ...
                    case "/":
                        if (n2 == 0)
                            throw new ExceptionExp("division by zero");
                        else
                            return new IntValue(n1 / n2);
                    default:
                        throw new ExceptionExp("operand does not exist");
                }
            }
            else
    ...
    public Type typecheck(MyIDictionary<String, Type> typeEnv) throws ExceptionExp, ExceptionADT {
        ...
        if (typ1.equals(new IntType())) {
            ...
            else throw new ExceptionExp("ArithExp: second operand is not an integer");
        }
        else throw new ExceptionExp("ArithExp: first operand is not an integer");
    }
